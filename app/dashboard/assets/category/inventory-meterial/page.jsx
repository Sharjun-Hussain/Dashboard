...
import { InventoryMeterialTable } from "./components/InventoryMeterialTable";

const InventoryMeterialPage = () => {
    ...
    <div className="">
      <div className="md:flex md:justify-between  md:space-x-6 -mx-4 md:mx-0 -mt-8 md:-mt-4">
        <div className="flex flex-col mb-3 md:mb-0  md:space-y-0 w-full">
          <h1 className="text-xl font-bold">Inventory Meterials</h1>
...
export default InventoryMeterialPage;
