...
import { MainCategoryTable, SubCategoryTable } from "./components/DataTable/SubCategoryTable";
    ...
    <div className="">
      <div className="container mx-auto">
        <CustomCard className="-mt-9" >
          ...
          <SubCategoryModal onUpdate={handleChildData} OpenModal={OpenModal} setOpenModal={setOpenModal} />
        </CustomCard>
